...
public class SymmetricEncoder {
    ...
    public static void main(String[] args) {
        ...
        String s1 = SymmetricEncoder.encrypt(content, key);
        System.out.println("加密内容:" + s1);
        String symmetricEncoder = SymmetricEncoder.decrypt(s1, key);
        System.out.println("解密内容:" + symmetricEncoder);
        Assert.assertEquals(content, symmetricEncoder);
